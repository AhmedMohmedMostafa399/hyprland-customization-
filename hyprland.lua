...
-- Hook into the hyprland startup event
-- Force core background commands to run strictly ONCE per session
...
-- Tell Qt apps to use qt5ct/qt6ct for styling
hl.env("QT_QPA_PLATFORMTHEME", "qt5ct")
hl.env("QT_QPA_PLATFORM", "wayland;xcb")

-- Look for your hl.exec or exec-once definitions and add:
hl.exec_cmd("~/.config/hypr/hypr-lang-notifier.sh")
...
hl.config({
  ...
  input = {
    ...
    -- Keep your existing touchpad/sensitivity settings here
    follow_mouse = 1,
    touchpad = {
        natural_scroll = false,
    },
...
-- Default springs
-- Bump stiffness to ~400-500
hl.curve("easy", { type = "spring", mass = 1, stiffness = 450, dampening = 35 })

-- Change speed from 10 down to 3 or 4!
...
hl.animation({ leaf = "windowsOut",      enabled = true,  speed = 3, bezier = "quick" })
...
hl.config({
    -- Your other config items (input, monitors, etc.)

    misc = {
        disable_hyprland_logo = true,
        disable_splash_rendering = true,
        force_default_wallpaper = 0, -- Prevents default anime/mascot art
    },
})
...
--shutdown
hl.bind("CTRL + ALT + SHIFT + Delete", hl.dsp.exec_cmd("poweroff"))
